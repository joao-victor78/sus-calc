...
export default function SUSForm({ systemName, onSystemNameChange, onSubmit }) {
  ...
  function handleSubmit(e) {
    ...
    const answeredCount = SUS_QUESTIONS.filter(question => answers[question.id] != null).length;
    if (answeredCount !== SUS_QUESTIONS.length) {
      setError('Por favor responda todos os itens antes de enviar.');
      return;
    }
    ...
    onSubmit(score, label, color, systemName);
    setAnswers({});
    setError('');
  }
